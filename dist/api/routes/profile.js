...
let ProfileRouter = class ProfileRouter extends baseRouter_1.default {
    ...
    routes() {
        ...
        this.router.get('/my-profile', auth_1.authenticate, this.profileController.findMyProfile);
        this.router.get('/:slug', this.profileController.findOne);
        return this;
    }
};
ProfileRouter = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.ProfileController))
], ProfileRouter);
