...
const sellerValidation = () => {
    return [
        ...
        (0, express_validator_1.body)("image", 'Foto bukti usaha harus di isi').optional({ nullable: true, checkFalsy: true }).default([]).isArray(),
        (0, express_validator_1.body)("image.*", 'Foto bukti usaha harus di isi').optional({ nullable: true, checkFalsy: true }).isString().isURL(),
        ...
        (0, express_validator_1.body)('ktp_image', 'Mohon masukan foto ktp anda').notEmpty().isString().isURL(),
