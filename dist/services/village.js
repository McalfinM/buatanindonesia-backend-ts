...
let VillageService = class VillageService {
    villageRepository;
    dispatcher;
    constructor(villageRepository, dispatcher) {
        this.villageRepository = villageRepository;
        this.dispatcher = dispatcher;
    }
    async findOne(uuid) {
        const provinceData = await this.villageRepository.findOne(uuid);
        return provinceData;
    }
    async findAll(query = {}) {
...
VillageService = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.TYPES.VillageRepository)),
