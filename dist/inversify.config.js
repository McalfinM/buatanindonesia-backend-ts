...
const payment_1 = __importDefault(require("./api/controllers/payment"));
const payment_2 = __importDefault(require("./api/routes/payment"));
const payment_3 = __importDefault(require("./repositories/payment"));
const payment_4 = __importDefault(require("./services/payment"));
...
(0, inversify_1.decorate)((0, inversify_1.injectable)(), baseRouter_1.default);
(0, inversify_1.decorate)((0, inversify_1.injectable)(), event_dispatch_1.EventDispatcher);
...
container.bind(types_1.TYPES.PaymentRouter).to(payment_2.default).inSingletonScope();
container.bind(types_1.TYPES.PaymentController).to(payment_1.default).inSingletonScope();
container.bind(types_1.TYPES.PaymentService).to(payment_4.default).inSingletonScope();
container.bind(types_1.TYPES.PaymentRepository).to(payment_3.default).inSingletonScope();
